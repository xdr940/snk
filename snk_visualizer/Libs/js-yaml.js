...
(function (global, factory) {
    ...
    function getLine(buffer, lineStart, lineEnd, position, maxLineLength) {
      ...
      return {
        str: head + buffer.slice(lineStart, lineEnd).replace(/\t/g, '¡ú') + tail,
    ...
    function writeScalar(state, string, level, iskey, inblock) {
      state.dump = (function () {
        ...
        //  state.lineWidth ¡Ü 40 + state.indent: width is fixed at the lower bound.
    ...
    function foldString(string, width) {
      // In folded style, $k$ consecutive newlines output as $k+1$ newlines¡ª
